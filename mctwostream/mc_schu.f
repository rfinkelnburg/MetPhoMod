      SUBROUTINE schu(nz,o2col,iw,secchi,dto2)
...
*=            grid                                                           =*
*=  O2COL   - DOUBLE PRECISION, slant overhead O2 column (molec/cc) at each specified (I)=*
*=            altitude                                                       =*
*=  IW      - INTEGER, index of current wavelength bin (Kockarts' grid)   (I)=*
*=  SECCHI  - DOUBLE PRECISION, 1/COS(SZA)  for SZA <= 75 deg                         (I)=*
...
*=  XSCHO2  - DOUBLE PRECISION, molecular absorption cross section in SR bands at     (O)=*
...
*-----------------------------------------------------------------------------*
      ...
      DOUBLE PRECISION o2col(kz),dto2(kz,16)
C     DOUBLE PRECISION dsdh(kz,kz)
